...
# Runs in parallel con Sq1/Clock/5x5. Only ~4 float free. Reduced to 3J+1S+1R.
AssignMisc(121, Persons(Or(BooleanProperty("volunteer"), BooleanProperty("listed-delegate"), BooleanProperty("unofficial_lead"))), [Job("Lead", 1, eligibility=BooleanProperty("unofficial_lead")), Job("judge", 3, eligibility=And(Not(BooleanProperty("score-taker")), HasProperty("staff-team"), (NumberProperty("staff-team") == 4))), Job("scrambler", 1, eligibility=And(Not(BooleanProperty("score-taker")), HasProperty("staff-team"), (NumberProperty("staff-team") == 4), BooleanProperty("can-scramble-333"))), Job("runner", 1, eligibility=And(Not(BooleanProperty("score-taker")), HasProperty("staff-team"), (NumberProperty("staff-team") == 4)))], [FollowingGroupScorer(-50), JobCountScorer(-5), PersonPropertyScorer((NumberProperty("staff-team") == 4), 300), PersonPropertyScorer((NumberProperty("pref-scrambler") >= 7), 100)], overwrite=true)
...
# Runs in parallel con 2x2/Pyram R1 + 4BLD. 0 float free — reduced to minimum.
AssignMisc(123, Persons(Or(BooleanProperty("volunteer"), BooleanProperty("listed-delegate"), BooleanProperty("unofficial_lead"))), [Job("Lead", 1, eligibility=BooleanProperty("unofficial_lead")), Job("judge", 1, eligibility=And(Not(BooleanProperty("score-taker")), HasProperty("staff-team"), (NumberProperty("staff-team") == 2))), Job("scrambler", 1, eligibility=And(Not(BooleanProperty("score-taker")), HasProperty("staff-team"), (NumberProperty("staff-team") == 2), BooleanProperty("can-scramble-333"))), Job("runner", 1, eligibility=And(Not(BooleanProperty("score-taker")), HasProperty("staff-team"), (NumberProperty("staff-team") == 2)))], [FollowingGroupScorer(-50), JobCountScorer(-5), PersonPropertyScorer((NumberProperty("staff-team") == 2), 300), PersonPropertyScorer((NumberProperty("pref-scrambler") >= 7), 100)], overwrite=true)
